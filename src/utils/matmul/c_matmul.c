...
int _matmul_##T1##_##T2(\
    ...
    for(i=0;i+4<=a;i+=4){\
        j=0;\
        for(;j+4<=c;j+=4){\
            register Ret c00=0,c01=0,c02=0,c03=0,\
            c10=0,c11=0,c12=0,c13=0,\
            c20=0,c21=0,c22=0,c23=0,\
            c30=0,c31=0,c32=0,c33=0;\
            register T1 a0k, a1k, a2k, a3k; register T2 bk0, bk1, bk2, bk3;\
            a0k_p = mat1+i*b;\
            a1k_p = mat1+(i+1)*b;\
            a2k_p = mat1+(i+2)*b;\
            a3k_p = mat1+(i+3)*b;\
        ...
        switch(rest_cnt){\
        case 3:{\
            register Ret c00=0,c01=0,c02=0,\
            c10=0,c11=0,c12=0,\
            c20=0,c21=0,c22=0,\
            c30=0,c31=0,c32=0;\
            register T1 a0k, a1k, a2k, a3k; register T2 bk0, bk1, bk2;\
            a0k_p = mat1+i*b;\
            a1k_p = mat1+(i+1)*b;\
            a2k_p = mat1+(i+2)*b;\
            a3k_p = mat1+(i+3)*b;\
        ...
        case 2:{\
            register Ret c00=0,c01=0,\
            c10=0,c11=0,\
            c20=0,c21=0,\
            c30=0,c31=0;\
            register T1 a0k, a1k, a2k, a3k; register T2 bk0, bk1;\
            a0k_p = mat1+i*b;\
            a1k_p = mat1+(i+1)*b;\
            a2k_p = mat1+(i+2)*b;\
            a3k_p = mat1+(i+3)*b;\
        ...
        case 1:{\
            ...
            c20=0,\
            c30=0;\
            register T1 a0k, a1k, a2k, a3k; register T2 bk0;\
            a0k_p = mat1+i*b;\
            a1k_p = mat1+(i+1)*b;\
            a2k_p = mat1+(i+2)*b;\
            a3k_p = mat1+(i+3)*b;\
    ...
    case 3:{\
        ...
        for(;j+4<=c;j+=4){\
            ...
            c10=0,c11=0,c12=0,c13=0,\
            c20=0,c21=0,c22=0,c23=0;\
            register T1 a0k, a1k, a2k; register T2 bk0, bk1, bk2, bk3;\
            a0k_p = mat1+i*b;\
            a1k_p = mat1+(i+1)*b;\
            a2k_p = mat1+(i+2)*b;\
            for(size_t k=0;k<b;++k){\
        ...
        case 3:{\
            ...
            c10=0,c11=0,c12=0,\
            c20=0,c21=0,c22=0;\
            register T1 a0k, a1k, a2k; register T2 bk0, bk1, bk2;\
            a0k_p = mat1+i*b;\
            a1k_p = mat1+(i+1)*b;\
            a2k_p = mat1+(i+2)*b;\
            for(size_t k=0;k<b;++k){\
        ...
        case 2:{\
            ...
            c10=0,c11=0,\
            c20=0,c21=0;\
            register T1 a0k, a1k, a2k; register T2 bk0, bk1;\
            a0k_p = mat1+i*b;\
            a1k_p = mat1+(i+1)*b;\
            a2k_p = mat1+(i+2)*b;\
            for(size_t k=0;k<b;++k){\
        ...
        case 1:{\
            ...
            c10=0,\
            c20=0;\
            register T1 a0k, a1k, a2k; register T2 bk0;\
            a0k_p = mat1+i*b;\
            a1k_p = mat1+(i+1)*b;\
            a2k_p = mat1+(i+2)*b;\
            for(size_t k=0;k<b;++k){\
    ...
    case 2:{\
        ...
        for(;j+4<=c;j+=4){\
            register Ret c00=0,c01=0,c02=0,c03=0,\
            c10=0,c11=0,c12=0,c13=0;\
            register T1 a0k, a1k; register T2 bk0, bk1, bk2, bk3;\
            a0k_p = mat1+i*b;\
            a1k_p = mat1+(i+1)*b;\
            for(size_t k=0;k<b;++k){\
                bk0 = mat2[k*c+j]; bk1 = mat2[k*c+1+j]; bk2 = mat2[k*c+2+j]; bk3 = mat2[k*c+3+j];\
        ...
        case 3:{\
            register Ret c00=0,c01=0,c02=0,\
            c10=0,c11=0,c12=0;\
            register T1 a0k, a1k; register T2 bk0, bk1, bk2;\
            a0k_p = mat1+i*b;\
            a1k_p = mat1+(i+1)*b;\
            for(size_t k=0;k<b;++k){\
                bk0 = mat2[k*c+j]; bk1 = mat2[k*c+1+j]; bk2 = mat2[k*c+2+j];\
        ...
        case 2:{\
            register Ret c00=0,c01=0,\
            c10=0,c11=0;\
            register T1 a0k, a1k; register T2 bk0, bk1;\
            a0k_p = mat1+i*b;\
            a1k_p = mat1+(i+1)*b;\
            for(size_t k=0;k<b;++k){\
                bk0 = mat2[k*c+j]; bk1 = mat2[k*c+1+j];\
        ...
        case 1:{\
            register Ret c00=0,\
            c10=0;\
            register T1 a0k, a1k; register T2 bk0;\
            a0k_p = mat1+i*b;\
            a1k_p = mat1+(i+1)*b;\
            for(size_t k=0;k<b;++k){\
                bk0 = mat2[k*c+j]; \
    ...
    case 1:{\
        ...
        for(;j+4<=c;j+=4){\
            register Ret c00=0,c01=0,c02=0,c03=0;\
            register T1 a0k; register T2 bk0, bk1, bk2, bk3;\
            a0k_p = mat1+i*b;\
            for(size_t k=0;k<b;++k){\
                bk0 = mat2[k*c+j]; bk1 = mat2[k*c+1+j]; bk2 = mat2[k*c+2+j]; bk3 = mat2[k*c+3+j];\
                a0k = *a0k_p++;\
        ...
        case 3:{\
            register Ret c00=0,c01=0,c02=0;\
            register T1 a0k; register T2 bk0, bk1, bk2;\
            a0k_p = mat1+i*b;\
            for(size_t k=0;k<b;++k){\
                bk0 = mat2[k*c+j]; bk1 = mat2[k*c+1+j]; bk2 = mat2[k*c+2+j];\
                a0k = *a0k_p++;\
        ...
        case 2:{\
            register Ret c00=0,c01=0;\
            register T1 a0k; register T2 bk0, bk1;\
            a0k_p = mat1+i*b;\
            for(size_t k=0;k<b;++k){\
                bk0 = mat2[k*c+j]; bk1 = mat2[k*c+1+j];\
                a0k = *a0k_p++;\
